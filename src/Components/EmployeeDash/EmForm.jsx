...
function EmForm({ setTasks, tasks, setLoad }) {
    ...
    return(
        <form onSubmit={formHandler} className="fieldset shadow-2xl h-fit bg-base-200 border-base-300 rounded-box w-xs border p-4">
            <legend className="fieldset-legend text-2xl text-red-700">Task Details</legend>

            <label className="label">Task</label>
            <select defaultValue="Pick a Task" className="select" name = "task">
            ...
            <input type="text" className="input" placeholder="Hours" name = "hour"/>
